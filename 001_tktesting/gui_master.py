...
class GuiMaster:
    ...
    def toolbar_ui(self):
        ...
        tabControl=ttk.Notebook(toolbar) #创建Notebook

        self.frame1 = LabelFrame(tabControl, text="Label-Label") #新建选项卡 tab1 
        # frame1.pack(side=tk.LEFT)
        frame2 = LabelFrame(tabControl, text="Label-BUtton")
        # frame2.pack(side=tk.LEFT)
        self.frame3 = Frame(tabControl)
        # frame3.pack(side=tk.LEFT)


        tabControl.add(self.frame1,text="空间布局") #把选项卡加到Notebook中
        tabControl.add(frame2,text="常见按钮")
        tabControl.add(self.frame3,text="交互")
